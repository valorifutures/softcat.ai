...
The speed difference is genuinely startling the first time you use it. Installing a project with 50 dependencies goes from "go make a coffee" to "already done." Hard to go back to regular pip after this.
