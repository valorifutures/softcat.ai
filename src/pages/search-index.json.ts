...
export const GET: APIRoute = async () => {
  ...
  const pages = [
    ...
    { title: 'Horizon: five possible AI futures', summary: 'What comes after now? Compare AGI, agents, robotics, software and education, with visible dates, evidence and uncertainty.', url: '/horizon', type: 'page', tags: ['AGI', 'future', 'scenarios', 'timeline'] },
